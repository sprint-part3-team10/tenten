  ...
  const res = await fetch(
    `${BASE_URL}/shops/${shopId}/notices/${noticeId}/applications?offset=${offset}&limit=5`,
    {
      headers: {
        ...
        // 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI1NmNhNmJmNC02YjZmLTRmNGYtOTczMS1iODM3Y2NkYmNiNmIiLCJpYXQiOjE3MTM4NjgxMzl9.GHg7XOLvw6AbVZz-ws4cVyJae5k3dGs8DZIR8Hu_BXk',
      },
      cache: 'no-store',
    },
  );
